    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        <div class="sidebar-brand-icon">
        	<img src="<?= base_url() ?>assets/img/logo.png" style="max-width:50px;">
          <!-- <i class="fas fa-laugh-wink"></i> -->
        </div>
        <div class="sidebar-brand-text mx-3">Puskesmas Kuala Enok</div>
      </a>
      ...
      $queryMenu = "SELECT `tb_user_menu`.`id_user_menu`, `menu`
					  FROM `tb_user_menu` JOIN `tb_user_access_menu` 
					    ON `tb_user_menu`.`id_user_menu` = `tb_user_access_menu`.`menu_id`
