      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; UPT Puskesmas Kula Enok <?= date('Y'); ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: ["Total Pemakaian", "Total Stok Awal", "Sisa Stok"],
    datasets: [{
      data: [<?= $sum_pemakaian->jmlPemakaian ; ?>, <?= $sum_obat->stokAwal ; ?>, <?= $sum_stok->sisaStok ; ?>],
